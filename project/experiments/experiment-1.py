...
def delayed_bitflip_experiment(data, results_folder='results/experiment-1'):
    results = []
...
# # analysis and plots
file_path = 'results/experiment-1/experiment-1-all_results.csv'
delayed_df = pd.read_csv(file_path)

accuracy_df, distribution_df = calculate_metrics(delayed_df)

accuracy_df.to_csv('results/experiment-1/experiment-1-accuracy.csv')
distribution_df.to_csv('results/experiment-1/experiment-1-proportions-count.csv')
